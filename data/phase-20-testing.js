const PHASE_TESTING = {
  ...
  tradeoffs:[{axis:"Coverage vs Speed",left:"More tests: slow CI",right:"Fewer: faster bugs",pos:0.5},{axis:"Pre-prod vs In-prod testing",left:"Staging: safe",right:"Prod chaos: realistic",pos:0.5}],
  levelUp:[
  ...
  children:[
    {name:"Load & Capacity",id:"test-load",icon:"📊",phase:"Testing",color:"#fb923c",
     ...
     tradeoffs:[{axis:"Realism vs Cost",left:"Real prod data: accurate",right:"Synthetic: cheap, less real",pos:0.5}],
     sizes_cfg:{
    ...
    {name:"Chaos Engineering",id:"test-chaos",icon:"🐒",phase:"Testing",color:"#fb923c",
     ...
     tradeoffs:[{axis:"Realism vs Risk",left:"Prod chaos: real",right:"Staging: safe",pos:0.5}],
     sizes_cfg:{
    ...
    {name:"Contract Testing",id:"test-contract",icon:"🤝",phase:"Testing",color:"#fb923c",
     ...
     tradeoffs:[{axis:"Coverage vs Coupling",left:"Contracts: lightweight",right:"E2E: thorough but slow",pos:0.6}],
     sizes_cfg:{
