const PHASE_MULTITENANCY = {
  ...
  tradeoffs:[{axis:"Cost efficiency vs Isolation",left:"Pooled: cheap, shared risk",right:"Siloed: expensive, isolated",pos:0.5},{axis:"Operational simplicity vs Per-tenant control",left:"Single deploy: simple",right:"Per-tenant: customizable",pos:0.5}],
  levelUp:[
  ...
  children:[
    {name:"Isolation Model",id:"tenant-iso",icon:"🚧",phase:"Multi-tenancy",color:"#06b6d4",
     ...
     tradeoffs:[{axis:"Density vs Blast radius",left:"All in one DB",right:"DB per tenant",pos:0.5}],
     sizes_cfg:{
    ...
    {name:"Noisy Neighbor",id:"tenant-noise",icon:"🔊",phase:"Multi-tenancy",color:"#06b6d4",
     ...
     tradeoffs:[{axis:"Strict quotas vs UX",left:"Tight: isolation",right:"Loose: best-effort fast",pos:0.5}],
     sizes_cfg:{
